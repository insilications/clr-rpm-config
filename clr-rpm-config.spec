...
Version  : 111
Release  : 112
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-111.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-111.tar.xz
