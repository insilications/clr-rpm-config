...
Version  : 118
Release  : 118
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-118.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-118.tar.xz
