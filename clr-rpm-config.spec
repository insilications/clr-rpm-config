...
Version  : 115
Release  : 115
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-115.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-115.tar.xz
