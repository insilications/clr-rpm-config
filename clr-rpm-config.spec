...
Version  : 114
Release  : 114
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-114.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-114.tar.xz
