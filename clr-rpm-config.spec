...
Version  : 206
Release  : 206
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-206.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-206.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557245238
export AR=gcc-ar
