...
Version  : 212
Release  : 212
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-212.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-212.tar.xz
...
%prep
%setup -q -n clr-rpm-config-212
cd %{_builddir}/clr-rpm-config-212
...
cp %{_builddir}/clr-rpm-config-212/LICENSE %{buildroot}/usr/share/package-licenses/clr-rpm-config/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
