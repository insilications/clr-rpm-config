...
Version  : 200
Release  : 200
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-200.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-200.tar.xz
