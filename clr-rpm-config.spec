...
%prep
%setup -q -n clr-rpm-config-217
cd %{_builddir}/clr-rpm-config-217
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574198934
...
cp %{_builddir}/clr-rpm-config-217/LICENSE %{buildroot}/usr/share/package-licenses/clr-rpm-config/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
