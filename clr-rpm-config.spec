...
Version  : 116
Release  : 116
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-116.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-116.tar.xz
