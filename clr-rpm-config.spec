...
Version  : 255
Release  : 291
URL      : file:///aot/build/clearlinux/packages/clr-rpm-config/clr-rpm-config-255.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-rpm-config/clr-rpm-config-255.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617792256
