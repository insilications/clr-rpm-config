...
Version  : 216
Release  : 218
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-216.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-216.tar.xz
...
%prep
%setup -q -n clr-rpm-config-216
cd %{_builddir}/clr-rpm-config-216
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574196494
...
cp %{_builddir}/clr-rpm-config-216/LICENSE %{buildroot}/usr/share/package-licenses/clr-rpm-config/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
