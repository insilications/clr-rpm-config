...
Version  : 201
Release  : 201
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-201.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-201.tar.xz
