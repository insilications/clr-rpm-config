...
Version  : 224
Release  : 224
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-224.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-224.tar.xz
...
%prep
%setup -q -n clr-rpm-config-224
cd %{_builddir}/clr-rpm-config-224
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618549819
...
cp %{_builddir}/clr-rpm-config-224/LICENSE %{buildroot}/usr/share/package-licenses/clr-rpm-config/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
