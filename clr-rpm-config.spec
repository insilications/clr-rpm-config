...
Version  : 113
Release  : 113
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-113.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-113.tar.xz
