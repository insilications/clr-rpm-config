...
Version  : 197
Release  : 197
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-197.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-197.tar.xz
